...
@section('content')
<section id="home" class="w3l-banner-adc">
            ...
            <div class="align-items-center">
                <div class="col-lg-12 banner-left text-center">
                    ...
                    <div class="mt-md-5 mt-4 mb-lg-0 mb-4">
                        ...
                        <a class="btn button-style-banner" href="#includes"><i
                                class="fa-solid fa-arrow-down-long fa-2x"></i></a>
                    </div>
                </div>
                        ...
                        {{-- <div class="activity-card-container"> --}}
                            <div class="col-md-4">
                                @if($tour->photos->count() === 1)
                                    ...
                                    {{-- <img class="activity-card-image" src="{{ $tour->photos->first()->url }}" alt=""> --}}
                                @endif
                            </div>
                            <div class="col-md-7">
